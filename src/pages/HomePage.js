...
const adminLinks = [
  ...
  { path: '/cms', icon: '🏫', label: 'University CMS', desc: 'Manage institution-specific content', color: '#7c3aed', bg: 'linear-gradient(135deg,#7c3aed,#a855f7)', img: 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=400&q=70' },
  { path: '/partner-management', icon: '🤝', label: 'Partners', desc: 'Manage referral partners and track attribution', color: '#059669', bg: 'linear-gradient(135deg,#059669,#10b981)', img: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?w=400&q=70' },
