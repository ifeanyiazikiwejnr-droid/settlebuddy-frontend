...
const studentLinks = [
  ...
  { path: '/graduate-visa', icon: '🎓', label: 'Graduate Visa', desc: 'Your guide to staying in the UK after your degree', color: '#0a5c44', bg: 'linear-gradient(135deg,#0a5c44,#0f7a5a)', img: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=400&q=70' },
